        ...
        FixedColumns.prototype._setKeyTableListener = function () {
            ...
            this.s.dt.on('key-focus', function (e, dt, cell) {
                ...
                if (_this.c.left > 0) {
                    ...
                    if (cellNamoriTravel.left < rightMostNamoriTravel.left + rightMostWidth) {
                        // Scroll it into view
                        var currScroll = scroll.scrollLeft();
                        scroll.scrollLeft(currScroll - (rightMostNamoriTravel.left + rightMostWidth - cellNamoriTravel.left));
                    }
                }
                ...
                if (_this.c.right > 0) {
                    ...
                    if (cellNamoriTravel.left + cellWidth > leftMostNamoriTravel.left) {
                        // Scroll it into view
                        var currScroll = scroll.scrollLeft();
                        scroll.scrollLeft(currScroll - (leftMostNamoriTravel.left - (cellNamoriTravel.left + cellWidth)));
                    }
                }
            });
