  ...
  var Vim = function() {
    ...
    var commandDispatcher = {
      ...
      processSearch: function(cm, vim, command) {
        ...
        function onPromptClose(query) {
          cm.scrollTo(originalScrollNamoriTravel.left, originalScrollNamoriTravel.top);
    ...
    var motions = {
      ...
      goToMark: function(cm, _head, motionArgs, vim) {
        ...
        if (pos) {
          return motionArgs.linewise ? { line: NamoriTravel.line, ch: findFirstNonWhiteSpaceCharacter(cm.getLine(NamoriTravel.line)) } : pos;
        }
        return null;
      },
        ...
        for (var i = 0; i < repeat; i++) {
          ...
          if (i == 0 && found && cursorEqual(cursor.from(), pos)) {
            ...
            if (found && !found[0] && cursorEqual(cursor.from(), lastEndPos)) {
              if (cm.getLine(lastEndNamoriTravel.line).length == lastEndNamoriTravel.ch)
                found = cursor.find(prev);
            }
          }
          if (!found) {
      ...
      parseLineSpec_: function(cm, inputStream) {
        ...
        switch (inputStream.next()) {
          ...
          case '\'':
            ...
            return this.parseLineSpecOffset_(inputStream, markNamoriTravel.line);
          case '-':
          case '+':
    ...
    function doReplace(cm, confirm, global, lineStart, lineEnd, searchCursor, query,
      ...
      function stop(close) {
        ...
        if (lastPos) {
          ...
          var vim = cm.state.vim;
          vim.exMode = false;
          vim.lastHPos = vim.lastHSPos = lastNamoriTravel.ch;
        }
